...
function buildFinalPrompt(context: string, question: string): string {
  ...
  return [
    ...
    '- Responda em português, em texto corrido com markdown legível (cabeçalhos ##, listas com -, negrito com **).',
    '- NÃO retorne JSON. Responda diretamente em texto.',
    '- Para cada categoria de erro relevante, crie uma seção com severidade, causa raiz, evidência do log e ações sugeridas.',
    '- Seja objetivo e técnico. Limite a resposta a no máximo 600 palavras.',
    '',
